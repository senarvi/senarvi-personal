...
GeoTools Plugin/Extention : Datasource created to read images georeferenced by a world file

To use this plugin/extention ensure that gt2-image.jar is on your classpath.
