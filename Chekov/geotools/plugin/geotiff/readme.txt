...
GeoTools Plugin/Extention : Datasource created to read GeoTIFF raster format. 

To use this plugin/extention ensure that gt2-geotiff.jar is on your classpath.
