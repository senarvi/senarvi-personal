...
tcount_u        = dword fs:_ledgebuf+esi*4+sedge.tex.u
tcount_v        = dword fs:_ledgebuf+esi*4+sedge.tex.v
...
getedge:
        ...
        getdelta svdata.tex.u,[count.tex.u],[delta.tex.u]
        getdelta svdata.tex.v,[count.tex.v],[delta.tex.v]
@@getedgef0:
        ...
        fixdiv  [delta.tex.u],ecx
        mov     [edge_tgrad.u],eax
        fixdiv  [delta.tex.v],ecx
        mov     [edge_tgrad.v],eax
@@getedgef1:
...
@@loop:
        ...
        addgrad [count.tex.u],[edge_tgrad.u],sedge.tex.u
        addgrad [count.tex.v],[edge_tgrad.v],sedge.tex.v
@@getedgef2:
...
@@drawpolyf1:
        ...
        getscangrad svdata.tex.u,[tgrad_u]      ; Texture map u-
        getscangrad svdata.tex.v,[tgrad_v]      ; & v-gradient
...
@@loop:
        ...
        mov     eax,[edx+esi*size smap+smap.u]
        if      U_TILE gt 1
        cmul    eax,U_TILE
        endif
        mov     [pdata.source.tex.u],eax

        mov     eax,[edx+esi*size smap+smap.v]
        if      V_TILE gt 1
        cmul    eax,V_TILE
        endif
        ...
        ; If one of the texture coordinates is in the upper portion of the
        ; last texture tile
